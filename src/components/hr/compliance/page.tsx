...
const ComplianceCard = memo(({ icon: Icon, title, description, children, footerText, iconColor }: ComplianceCardProps) => (
    <Card>
        <CardHeader>
