    ...
    onSave(data);
     if (user && firestore) {
        createNotification(firestore, user.uid, {
            ...
            description: `Entrega para ${data.client} en ${data.destination}`,
      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>Registrar Nueva Entrega</DialogTitle>
           <DialogDescription>
            Completa la información para programar una nueva entrega.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
             ...
             <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Ej: Bodega Central, Morelia" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
